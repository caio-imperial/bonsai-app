                ...
                <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li className="nav-item">
                        <Link href="/" className="nav-link align-middle px-0">
                            <i className="fs-4 bi-house"></i> <span className="ms-1 d-none d-sm-inline">Meus bonsais</span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link href="/bonsais/new" className="nav-link align-middle px-0">
                            <i className="fs-4 bi-plus"></i> <span className="ms-1 d-none d-sm-inline">Novo bonsai</span>
                        </Link>
                    </li>
                </ul>
                <hr />
